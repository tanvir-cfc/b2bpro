        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 bg-emerald-900/80 border border-emerald-500/40 text-amber-300 px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-wide">
              ...
              <span>Grossiste & Importateur Direct Afrique - Europe</span>
            </div>

            {/* Main Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white leading-[1.15]">
              LE PARTENAIRE EUROPÉEN DES <br className="hidden sm:inline" />
            ...
            <p className="text-emerald-100 text-base sm:text-lg max-w-2xl font-normal leading-relaxed">
              Des produits authentiques (Madd, Café Touba, Bissap, Mangue, Baobab), importés directement d'Afrique, au meilleur prix pour les épiceries, grandes surfaces, parapharmacies et distributeurs.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
              <button
                ...
                className="w-full sm:w-auto bg-[#ea580c] hover:bg-[#c2410c] text-white px-7 py-3.5 rounded-xl font-extrabold text-sm uppercase tracking-wider transition-all shadow-lg hover:shadow-orange-950/50 flex items-center justify-center gap-2.5 group"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto border-2 border-emerald-300/40 hover:border-white text-emerald-50 hover:bg-white/10 px-6 py-3.5 rounded-xl font-bold text-sm tracking-wide transition-all flex items-center justify-center gap-2"
              >
          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none bg-gradient-to-tr from-emerald-900/60 to-emerald-800/20 p-4 sm:p-6 rounded-2xl border border-emerald-500/30 shadow-2xl backdrop-blur-sm">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="bg-white/90 rounded-xl p-3 text-gray-900 shadow-md border border-amber-200 group hover:scale-[1.02] transition-transform">
                  <div className="relative h-32 sm:h-36 rounded-lg bg-amber-50 overflow-hidden flex items-center justify-center">
                    <img 
                ...
                <div className="bg-white/90 rounded-xl p-3 text-gray-900 shadow-md border border-amber-200 group hover:scale-[1.02] transition-transform">
                  <div className="relative h-32 sm:h-36 rounded-lg bg-amber-900/10 overflow-hidden flex items-center justify-center">
                    <img 
                ...
                <div className="bg-white/90 rounded-xl p-3 text-gray-900 shadow-md border border-amber-200 group hover:scale-[1.02] transition-transform">
                  <div className="relative h-32 sm:h-36 rounded-lg bg-rose-50 overflow-hidden flex items-center justify-center">
                    <img 
                ...
                <div className="bg-white/90 rounded-xl p-3 text-gray-900 shadow-md border border-amber-200 group hover:scale-[1.02] transition-transform">
                  <div className="relative h-32 sm:h-36 rounded-lg bg-amber-100 overflow-hidden flex items-center justify-center">
                    <img 
